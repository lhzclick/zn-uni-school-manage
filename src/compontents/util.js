export default {
    ...
    xlsx:{
        getGridDataToJson: function(id){
            var headData = document.querySelectorAll(id+" .ant-table-thead .ant-table-cell")
            var contentData = document.querySelectorAll(id+" .ant-table-tbody tr")
            ...
            for(var i=0,j=contentData.length;i<j;i++){
                var cellData = contentData[i].querySelectorAll(".ant-table-cell")
                var cellObj = {}
